...
func _draw():
	...
	var divisor_float : float = topleft_world_snapped_x / config.TILE_DIMENSION_FAR
	var divisor_int : int = floori(divisor_float)
	var far_start_x : int = divisor_int * config.TILE_DIMENSION_SKY
	...
	var far_start_y : int = divisor_int * config.TILE_DIMENSION_SKY
