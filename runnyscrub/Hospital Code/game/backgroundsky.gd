...
func _draw():
	...
	draw_texture_rect_region(offscreen_texture, Rect2(offscreen_background_sky.Render_World_TopLeft_Position.x, \
											offscreen_background_sky.Render_World_TopLeft_Position.y, \
